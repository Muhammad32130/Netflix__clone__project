...
function Plans({products}:Props) {
    ...
    return (
        ...
        <button className='text-lg font-medium hover:underline' onClick={logout}>Sign Out</button>
            ...
            <main className='mx-atuo max-w-5xl px-5 pt-28 pb-12 transition-all md:px-10'>
                <h1 className='mb-3 text-3xl font-medium'>Choose the plan that's right for you</h1>
                <ul>
                    <li><CheckIcon className='h-7 w-7 text-[#E50914]'/> Watch all you want. Ad-free.</li>
                    <li><CheckIcon className='h-7 w-7 text-[#E50914]'/> Recommendations just for you.</li>
                    <li><CheckIcon className='h-7 w-7 text-[#E50914]'/> Change or cancel your plan anytime.</li>
                </ul>
